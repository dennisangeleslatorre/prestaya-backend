...
import { getDepartamentos, getDepartamentosAdmin, getDepartamentoByCodigoDepartamento, registerDepartamento, updateDepartamento,deleteDepartamento} from '../controllers/departamento.controller'
...
router.post('/delete', passport.authenticate('jwt', { session: false }), deleteDepartamento );
