...
import { getCompania, getCompaniaAdmin, registerCompania, getCompaniaByCodigoCompania, updateCompania, deleteCompania, getCompaniaToFormato } from '../controllers/compania.controller'
...
router.get('/:c_compania/getCompaniaToFormato', passport.authenticate('jwt', { session: false }), getCompaniaToFormato);
