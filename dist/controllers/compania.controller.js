...
exports.deleteCompania = exports.updateCompania = exports.getCompaniaByCodigoCompania = exports.registerCompania = exports.getCompaniaAdmin = exports.getCompania = void 0;
...
function deleteCompania(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const c_compania = req.params.c_compania;
            const conn = yield (0, database_1.connect)();
            yield conn.query('DELETE FROM MA_COMPANIA WHERE c_compania = ?', [c_compania]);
            yield conn.end();
            ...
            if (errorAux.errno === 1217)
                message = "No se puede eliminar la compañía debido a que tiene datos asociados";
            return res.status(500).send({ error: error, message: message });
        }
    });
}
